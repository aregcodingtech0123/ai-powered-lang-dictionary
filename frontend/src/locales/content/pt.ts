...
const content: ContentI18n = {
    howItWorks: {
      title: "Como funciona",
      paragraphs: [
        "O AI Dictionary transforma uma palavra em um verbete voltado ao aprendizado: significados concisos no idioma alvo, uma explicação curta e frases de exemplo que mostram uso real. O objetivo é passar de “reconheço” para “sei usar corretamente”.",
