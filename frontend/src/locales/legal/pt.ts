...
const legal: LegalTranslations = {
    about: { title: "Sobre", intro: ["O VocaBeacon é uma plataforma multilíngue com IA e exemplos alinhados ao CEFR para aprender vocabulário com contexto."], sections: [
    ...
    privacy: { title: "Política de Privacidade", intro: ["Esta política explica como coletamos e usamos informações ao usar o VocaBeacon."], sections: [
    ...
    terms: { title: "Termos de Serviço", intro: ["Estes termos regulam seu uso do VocaBeacon."], sections: [
